...
import cleaningImg      from './assets/services/cleaning4.jpg'
import maintenanceImg   from './assets/services/maintenance2.jpg'
import pestControlImg   from './assets/services/pest-control.jpeg'
import propertyCareImg  from './assets/services/property_Care.jpg'
...
function App() {
  ...
  const handleSubmit = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    // Netlify Forms is only active after deployment — simulate locally
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* ── Trust Band ── */}
        <div className="trust-band" aria-label="Sectors served and service standards">
          {/* SVG wave — hero white bleeds smoothly into band */}
          <svg className="trust-band-wave" viewBox="0 0 1440 36" preserveAspectRatio="none" aria-hidden="true">
            <path d="M0,0 L1440,0 L1440,12 C1080,36 360,36 0,12 Z" fill="#ffffff"/>
          </svg>
          ...
          <div className="container">
            <div className="trust-band-card">
              ...
              <div className="tb-half">
                <p className="tb-half-label">Sectors We Serve</p>
                <ul className="tb-grid">
                  {TRUST_SECTORS.map(({ label, icon }) => (
                    <li key={label} className="tb-item">
                      <span className="tb-item-icon">{icon}</span>
                      <span className="tb-item-label">{label}</span>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              {/* Right — metrics */}
              <div className="tb-half">
                <p className="tb-half-label">Our Standards</p>
                <ul className="tb-grid">
                  {TRUST_METRICS.map(({ label, icon }) => (
                    <li key={label} className="tb-item tb-item--metric">
                      <span className="tb-item-icon tb-item-icon--gold">{icon}</span>
                      <span className="tb-item-label">{label}</span>
                    </li>
                  ))}
                </ul>
        ...
        <section id="contact" className="contact">
          <div className="container">
            ...
            <div className="ct-section-head">
              ...
              <h2 className="ct-section-title">Request a Proposal</h2>
              <p className="ct-section-sub">Fast, compliant facilities support across Uganda</p>
            </div>
            ...
            <div className="contact-inner">
              ...
              <div className="ct-info">
                <ul className="ct-trust-list">
                  {['HSE Compliant', 'Nationwide Coverage', 'Trained Teams', 'SLA Reporting'].map(item => (
                    <li key={item} className="ct-trust-item">
                      <svg viewBox="0 0 20 20" width="18" height="18" fill="none" aria-hidden="true">
                        <circle cx="10" cy="10" r="9" fill="rgba(212,166,42,0.12)" stroke="#D4A62A" strokeWidth="1.25"/>
                        <path d="M6.5 10l2.5 2.5 5-5" stroke="#D4A62A" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      {item}
                    </li>
                  ))}
                ...
                <div className="ct-contact-strip">
                  <a href="tel:+25677222120" className="ct-contact-phone">
                  ...
                  <a href="https://wa.me/25677222120" className="ct-contact-whatsapp" target="_blank" rel="noopener noreferrer">
